...
{
  "data": [
    { "id": "uuid", "name": "Free", "tierLevel": 1, "maxUsers": 3, "moduleAccess": ["auth","tenancy","crm","agenda"], "isActive": true },
    { "id": "uuid", "name": "Pro", "tierLevel": 2, "maxUsers": 25, "moduleAccess": ["auth","tenancy","crm","agenda","sales","inventory"], "isActive": true }
  ],
  "total": 2
}
```
